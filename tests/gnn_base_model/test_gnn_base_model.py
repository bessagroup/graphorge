...
@pytest.mark.parametrize(
    ...
    'n_time_node, n_time_edge, n_time_global, n_message_steps,'
    ...
    'device_type',
    [(2, 5, 4, 3, 2, 2, 0, 0, 0, 10, 2, 3,
      'graph_neural_network_model', True, True, 'add', 'add', 'relu',
      'identity', 'cpu'),
     (0, 5, 4, 0, 3, 3, 0, 0, 0, 10, 2, 3,
      'graph_neural_network_model', True, True, 'add', 'add', 'relu',
      'identity', 'cpu'),
     (2, 5, 0, 0, 2, 4, 0, 0, 0, 10, 2, 3,
      'graph_neural_network_model', True, True, 'add', 'add', 'relu',
      'identity', 'cpu'),
     (2, 5, 4, 3, 2, 2, 2, 2, 2, 10, 2, 3,
      'graph_neural_network_model', True, True, 'add', 'add', 'relu',
      'identity', 'cpu'),
     (0, 5, 4, 0, 3, 3, 5, 5, 5, 10, 2, 3,
      'graph_neural_network_model', True, True, 'add', 'add', 'relu',
      'identity', 'cpu'),
     (2, 5, 0, 0, 2, 4, 5, 5, 5, 10, 2, 3,
      'graph_neural_network_model', True, True, 'add', 'add', 'relu',
      'identity', 'cpu'),
     ])
def test_gnn_base_model_init(n_node_in, n_node_out, n_edge_in, n_edge_out,
                             n_global_in, n_global_out, n_time_node, 
                             n_time_edge, n_time_global, n_message_steps,
                             n_hidden_layers, hidden_layer_size, model_name,
    ...
    if not all([model._n_node_in == n_node_in,
                ...
                model._n_time_node == n_time_node,
                model._n_time_edge == n_time_edge,
                model._n_time_global == n_time_global,
